...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * Açık: teklif şablonu tek font (DejaVu Sans) kullanıyor ve bu font
         * TTF olarak ~700KB; subsetting kapalıyken her PDF'e TAMAMI gömülüyor
         * (tek sayfalık bir teklif için bile ~860KB çıktı gözlemlendi).
         * Subsetting açıkken yalnızca belgede fiilen kullanılan glyph'ler
         * gömülür — Türkçe karakter/₺ round-trip testi (QuotePdfTest) bu
         * ayarla birlikte YİNE yeşil, yani gerçekte kullanılan Türkçe
         * glyph'ler subset'ten düşmüyor.
         */
         ...
         * @var string
         */
        // Türkçe karakterler (ı İ ş Ş ğ Ğ ü Ü ö Ö ç Ç) ve ₺ simgesi için varsayılan
        // temel PDF fontları (Helvetica/Times) yetersiz kalıyor; dompdf'in gömülü
        // DejaVu Sans'ı Unicode/Türkçe glyph'leri kapsıyor. Bkz. resources/views/pdf/quote.blade.php.
