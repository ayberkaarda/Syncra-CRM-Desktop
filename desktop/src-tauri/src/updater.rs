...
//! requires the minisign **private** key for `4CE97F70B4BEFE48`, which is held only by the
...
mod tests {
    ...
    /// release pipeline signs with: key id `4CE97F70B4BEFE48`.
    ///
    ...
    #[test]
    fn the_configured_pubkey_is_the_real_minisign_key_for_4ce97f70b4befe48() {
        const EXPECTED_KEY_ID: &str = "4CE97F70B4BEFE48";
