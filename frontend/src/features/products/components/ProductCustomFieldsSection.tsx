// Özel alanlar bölümü — `/api/custom-fields?entity_type=products`'tan dinamik olarak üretilir.
// Aynı desen `deals/components/DealCustomFieldsSection.tsx` içinde de var; ayrı kopya olarak
// tutuluyor (her modül kendi tiplerini/dosyalarını taşır).
import { useTranslation } from 'react-i18next'
import { Checkbox, Input, Select, Textarea } from '../../../components/ui'
import type { ProductCustomField } from '../api/productsShared'

export type ProductCustomFieldsSectionProps = {
...
export function ProductCustomFieldsSection({ fields, values, onChange, errors }: ProductCustomFieldsSectionProps) {
