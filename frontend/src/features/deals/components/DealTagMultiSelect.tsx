// Etiket çoklu seçimi — `contacts/components/TagMultiSelect.tsx` ile aynı desen, deals
...
export type DealTagMultiSelectProps = {
  value: DealTag[]
  onChange: (next: DealTag[]) => void
  options: DealTag[]
  label?: string
  isLoading?: boolean
}

export function DealTagMultiSelect({ value, onChange, options, label, isLoading }: DealTagMultiSelectProps) {
  ...
  function toggleTag(tag: DealTag) {
