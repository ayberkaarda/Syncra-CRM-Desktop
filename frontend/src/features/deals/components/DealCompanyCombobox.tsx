// Firma seçimi için aranabilir tekli combobox — `contacts/components/CompanyCombobox.tsx`
// ile aynı desen, deals modülünün kendi (geçici) `dealsShared` tiplerine bağlı ayrı kopyası.
...
import { useDealCompanyOptionsSearch } from './dealsShared'
import type { CompanyOption } from '../types'
import { useDebouncedValue } from '../hooks/useDebouncedValue'

export type DealCompanyComboboxProps = {
...
export function DealCompanyCombobox({
  value,
  onChange,
  label,
  error,
  placeholder,
}: DealCompanyComboboxProps) {
  ...
  const { data: options, isLoading } = useDealCompanyOptionsSearch(debouncedDraft, { enabled: open })
