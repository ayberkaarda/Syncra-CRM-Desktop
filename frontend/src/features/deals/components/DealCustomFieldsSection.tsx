// Özel alanlar bölümü — `/api/custom-fields?entity_type=deals`'ten dinamik olarak üretilir.
// Aynı desen `leads/components/CustomFieldsSection.tsx` içinde de var; ayrı kopya olarak
...
import type { DealCustomField } from './dealsShared'

export type DealCustomFieldsSectionProps = {
...
export function DealCustomFieldsSection({ fields, values, onChange, errors }: DealCustomFieldsSectionProps) {
